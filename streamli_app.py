...
""", unsafe_allow_html=True)
st.write('')
st.markdown("""<p style='text-align: right;'> الاستنتاج: استئجار شقة في حي العقيق (بنظام الإيجار السنوي) يعتبر الخيار الأنسب ليوسف، نظرًا لقربه من مقر العمل وأسعاره المناسبة، حيث يبلغ متوسط الإيجار حوالي 36,000 ريال سعودي. يتميز الحي بموقعه الاستراتيجي بالقرب من مقر العمل، إضافة إلى قربه من المرافق الحيوية، وتوفر الخدمات التعليمية والصحية، و تنوع الخيارات السكنية، مما يجعله بيئة سكنية مريحة ومتكاملة.</p>""", unsafe_allow_html=True)
